...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        disableClick();
        //This function waits 1 secound before placing the image
        //and enabling click.
    ...
    function computersTurn() {
        ...
        while(!success) {
            ...
            //If the random number evaluates return true, the square hasnt been selected yet.
...
//drawWinLane function is called to draw line if condition is met.
...
// This function checks if any array include 3 strings.
...
function arrayIncludes(squareA, squareB, squareC) {
    ...
    //If the 3 variables we pass all include in our array true is 
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        // This variable creates the loop for when the game endsits restarts.
